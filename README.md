...
-   All Orders ⚖
    ...
    -   Create Products ✔️
        -   name\*
        -   Description \*
        -   Category \* like:- RomCom, Dystopian, Thriller , Self-Help Books, Fiction , Children Books and so on🧩
    -   All product 💻
...
-   Shop Inbox 📞
    -   All Messages 📬
    -   Send Image to user 🖼️
    -   Show Active function 🟢
-   Discount Codes 🎟️
    -   Create coupon code 
    -   Delete coupon code 
    -   apply all Products of the shop 
    -   Can apply the specific product 1️
-   Refunds 🔙
...
-   Admin Authentication Pages (normal user in DB roll in Admin) 🚪
    -   Admin Signup 
    -   Admin Login 
    -   Overview  - Total Earning  - All Sellers  - All Orders  - Latest Orders 
